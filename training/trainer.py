...
logging berkala, evaluasi berkala di data validasi, dan checkpointing berkala.
"""
...
class Trainer:
    def __init__(self, model, train_dataset, val_dataset, config):
        ...
        if config.training.resume_from:
            ...
            print(f"Resume dari step {self.step}, best_val_loss={self.best_val_loss:.4f}")
    ...
    def train(self):
        ...
        while self.step < self.max_steps:
            ...
            if self.step % cfg.log_every == 0:
                ...
                print(f"step {self.step:6d} | loss {loss.item():.4f} | lr {lr:.2e} | {dt:.1f}s")
                t0 = time.time()

            if self.step > 0 and self.step % cfg.eval_every == 0:
        ...
        print("Training selesai. Checkpoint akhir tersimpan.")
